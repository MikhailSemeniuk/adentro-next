            ...
            <section className="dark:bg-gray-900">
                <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                    ...
                    <div className="pt-8 text-left border-t border-gray-200 md:gap-16 dark:border-gray-700 md:grid-cols-2">
                        ...
                        <p className="mb-4 text-lg font-normal text-gray-500 dark:text-gray-400">
                            For more information or questions about our privacy practices, contact us at <a
                            className={`font-medium text-blue-600 dark:text-blue-500 hover:underline`} href="mailto:info@unilime.group">info@unilime.group</a>.
                        </p>
                    </div>
                </div>
            </section>
